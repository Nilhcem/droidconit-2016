package com.nilhcem.droidconae.data.database.dao;

import android.database.Cursor;

import com.nilhcem.droidconae.core.moshi.LocalDateTimeAdapter;
import com.nilhcem.droidconae.data.app.SelectedSessionsMemory;
import com.nilhcem.droidconae.data.database.DbMapper;
import com.nilhcem.droidconae.data.database.model.SelectedSession;
import com.nilhcem.droidconae.data.database.model.Session;
import com.nilhcem.droidconae.utils.Preconditions;
...
public class SessionsDao {
    ...
    public Observable<List<com.nilhcem.droidconae.data.app.model.Session>> getSessions() {
        return getSessions("SELECT * FROM " + Session.TABLE);
    }

    public Observable<List<com.nilhcem.droidconae.data.app.model.Session>> getSelectedSessions() {
    ...
    public Observable<List<com.nilhcem.droidconae.data.app.model.Session>> getSelectedSessions(LocalDateTime slotTime) {
    ...
    public void toggleSelectedSessionState(com.nilhcem.droidconae.data.app.model.Session session, boolean insert) {
    ...
    public void saveSessions(List<com.nilhcem.droidconae.data.app.model.Session> toSave) {
        Preconditions.checkNotOnMainThread();

        BriteDatabase.Transaction transaction = database.newTransaction();
        try {
            database.delete(Session.TABLE, null);
            for (com.nilhcem.droidconae.data.app.model.Session session : toSave) {
    ...
    public Observable<Boolean> isSelected(com.nilhcem.droidconae.data.app.model.Session session) {
    ...
    private Observable<List<com.nilhcem.droidconae.data.app.model.Session>> getSessions(String query, String... args) {
